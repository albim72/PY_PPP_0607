...
class Book:
    ...
    @staticmethod
    def test_method(info):
        print(f"test metody: {info}")
...
b1 = Book("Python 101 przepisów!","Marcin Albiniak",2022,340,60.0)
...
print("***********************************************")
Book.test_method("test metody")
b1.test_method("test metody")
print(Book.test)
